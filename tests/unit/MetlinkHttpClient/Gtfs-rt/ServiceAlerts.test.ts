...
describe("Metlink Http Client: GTFS-RT: Service alerts", () => {
        ...
        return {
            ...
            "properties": {
                "header": {
                    "type": "object",
                    "properties": {
                        "gtfsRealtimeVersion": {"type": "string"},
                        "incrementality": {"type": "integer"},
                                ...
                                "properties": {
                                    ...
                                    "informed_entity": {
                                        ...
                                        "items": {
                                            ...
                                            "required": ["stop_id", "route_id", "route_type", "trip"]
                                        }
                                    },
    ...
    it.each(dataSet)("getServiceAlerts", async (mockData) => {
        mock.onGet("/gtfs-rt/servicealerts").replyOnce(200, function () {
        ...
        const response = await client.getServiceAlerts();
