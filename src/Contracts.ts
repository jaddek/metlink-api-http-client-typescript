...
export interface MetlinkHttpClientInterface
    extends TripCancellationInterface,
...
export interface GTFSInterface {
    ...
    getGtfsStopTimes(tripId: string): Promise<any>

    getGtfsStops(routeId?: string | null, tripId?: string | null): Promise<any>
...
export interface GTFSRealTimeInterface {
    getGtfsRtServiceAlerts(useProtoBuf?: boolean): Promise<any>

    getGtfsRtTripUpdates(useProtoBuf?: boolean): Promise<any>

    getGtfsRtVehiclePositions(useProtoBuf?: boolean): Promise<any>
}

export interface StopDeparturePredictionsInterface {
    getStopPredictions(stopId: string): Promise<any>
}
